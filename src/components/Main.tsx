...
export const Main = () => {
  ...
  return (
    <div className="w-[400px] h-[375px] pt-6 pl-6">
      <div className="flex mb-6 items-center ">
        ...
        />
        <div>
          <h3 className="mb-2">Арслан Валиев</h3>
          <ul className="flex">
            <li className=" mr-4 ">
              <a
                href="https://t.me/my_try"
            ...
            <li className="flex items-center ">
              <a
                href="https://kazan.hh.ru/resume/9d4d7a5cff0bfb8b1e0039ed1f6373794b5874"
                className="flex items-center"
                rel="noreferrer"
                target="_blank"
              >
        ...
        {() => (
          <Form className="border-t pt-6 ">
            ...
            <Field
              ...
              className="mb-12"
            ></Field>
            <button id="button-start" type="submit" className="">
              Начать
            </button>
          </Form>
        )}
